        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (parts.length >= 4) {
                    ...
                    reviews.append("Customer Review for Task ").append(parts[0]).append(": ").append(review).append("\n");
                }
            }
            ...
            // Set the reviews to the jTextArea1
            jTextArea1.setText(reviews.toString());
        } catch (IOException e) {
            e.printStackTrace();
            // Show an error message for file reading failure
            javax.swing.JOptionPane.showMessageDialog(this, "Error reading reviews.", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    }
    /**
