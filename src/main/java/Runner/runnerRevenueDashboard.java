...
private void displayRevenue() {
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (parts.length >= 4) {
                    // Extract the status and amount parts
            ...
            // Set the total revenue to the jTextArea1
            jTextArea1.setText("Total Revenue: $" + totalRevenue);
        } catch (IOException | NumberFormatException e) {
            e.printStackTrace();
            // Show an error message for file reading or parsing failure
            javax.swing.JOptionPane.showMessageDialog(this, "Error calculating total revenue.", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(runnerRevenueDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
